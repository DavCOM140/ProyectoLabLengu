...
<span class="add-border"></span>
  ...
  function allanswers() {
	...
	var answers = ['le blois', 'les mots' , 'parler', 'les gens', 'nager', "d'accord", 'combien', 'au revoir', 'salut', 'avec plaisir' ];
	...
	function writean() {
			var allstring = '<h1>GOOD ANSWERS</h1>' + '<h2>Your Score is ' + score + '</h2>';
